(function () {
    ...
    ui.Pages.define("/pages/groupDetail/groupDetail.html", {
        ...
        init: function (element, options) {
            var group = HomescreenData.resolveGroupReference(options.groupKey);
            this._items = HomescreenData.getItemsFromGroup(group);
        ...
        _itemInvoked: function (args) {
            ...
            WinJS.Navigation.navigate("/pages/itemDetail/itemDetail.html", { item: HomescreenData.getItemReference(item) });
        }
    });
})();
