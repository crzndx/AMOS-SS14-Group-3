(function () {
    ...
    function generateSampleData() {
        ...
        var sampleItems = [
            ...
            { group: sampleGroups[3], title: "Squares", subtitle: "Displays KPI in squares of different sizes", description: itemDescription, content: itemContent, backgroundImage: "/images/groupedItems/blankPage.jpg", path: "/pages/squares/squares.html" },
