(function () {
    ...
    function generateSampleData() {
        ...
        var sampleItems = [
            ...
            { group: sampleGroups[0], title: "Squares", subtitle: "Displays KPI in squares of different sizes", description: itemDescription, content: itemContent, backgroundImage: "/images/groupedItems/squares.jpg", path: "/pages/squares_zoom/squares_zoom.html" },
            ...
            { group: sampleGroups[0], title: "Squares", subtitle: "Displays KPI in squares of different sizes", description: itemDescription, content: itemContent, backgroundImage: "/images/groupedItems/squares.jpg", path: "/pages/squares_original/squares_original.html" },
